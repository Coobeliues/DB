...
insert into movie(title)  values ('1+1');
...
insert into person(name, year_of_birth) values ('Shyngys', 2003);
select * from person;
...
insert into product(id, name, price) values (784714,'Fanta', 400);
...
insert into empl values (9,'Quanysh','01-06-1991',21,50000,6,2);
